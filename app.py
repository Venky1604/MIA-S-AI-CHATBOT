...
knowledge = '''Mia's Hair & Beauty Supply - Store Knowledge Base

Store Name:
Mia's Hair & Beauty Supply, Hartford CT

Website:
https://ctmiabeauty.com/

Address:
59 Albany Ave, Hartford, CT 06120

Phone:
860-206-8732

Email:
miashairbeauty@gmail.com

Pickup:
Online ordering and free curbside pickup are available.

Store Description:
Mia's Hair & Beauty Supply is a beauty supply store in Hartford, Connecticut. The website describes the store as having more than 10,000 wigs in stock and many crochet braiding hair options.
...
- Jewelry
- Clippers and Outliners

Example Products and Prices Listed on Website:
- Sensationnel Bare Lace 13X6 Unit 21: $56.99
- Sensationnel Bare Lace 6x5 Unit 6: $48.99
- Sensationnel HD Lace Front Cloud 9 What Lace Keshona: $62.99
- Outre Lucienne Lacefront Melted Hairline Wig: Sale $44.99, regular $65.99
- Vivace by Kiss Gold Unit 11 Lace Front Wig: Sale $26.99, regular $45.99
- X-PRESSION Pre-Stretched Braid 3X 52 inch: $5.49
- Glance Crochet Braid By Model Model 2X River Loc 14 inch: Sale $8.99, regular $11.99
- Wild Growth Hair Oil: $8.99
- Rat Tail Comb: $1.00
- Broadway Clear Lip Gloss: $1.29
- Edge Brush: $1.99
- Hair Scissor: $2.49

Return Policy:
Items generally need to be unused and in original condition. Some products such as opened wigs, sale items, or personal beauty products may not be returnable. Customers should confirm the current return policy with the store before purchase.

Promotions:
The website lists sale sections such as:
- 2024 New Wigs Special Sale
- Sale Wig
- Big Sale Wig
- Bundle Hair Sale
- Quick Pickup Items
Promotions and prices may change, so customers should check the website or call the store.

Important Chatbot Instruction:
If exact price, inventory, size, color, brand availability, store hours, or current promotion is not known, the chatbot should ask the customer to call 860-206-8732 or check the website.
'''

readme = '''# Mia's Beauty Supply Streamlit Chatbot
...
This is Version 1: rule-based chatbot.
It answers store questions using known store information and safely redirects unknown questions to the store phone/email.
'''
